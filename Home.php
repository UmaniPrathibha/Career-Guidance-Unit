  ...
  <div class="container">
    ...
    <nav>
      <div class="nav-fostrap">
        <ul>
            <li><a href="HomeHeader.php">Home</a></li>
          <li><a href="javascript:void(0)">About CGU<span class="arrow-down"></span></a>
            <ul class="dropdown">
          ...
          <li><a href="javascript:void(0)" >Services<span class="arrow-down"></span></a>
            <ul class="dropdown">
                <li><a href="WSP.php">Workshop</a></li>
                <li><a href="APT.php">Appointment</a></li>
              <li><a href="SUP.php">Start Ups</a></li>
            </ul>
          </li>
          <li><a href="javascript:void(0)" >Survey<span class="arrow-down"></span></a>
            <ul class="dropdown">
                <li><a href="emphome.php">Employability Survey</a></li>
                <li><a href="stuhome.php">Student Satisfaction Survey</a></li>
            </ul>
          </li>
		  <li><a href="javascript:void(0)" >Career<span class="arrow-down"></span></a>
            <ul class="dropdown">
                <li><a href="GP.php">GPA</a></li>
              <li><a href="CVH.php">CV</a></li>
            </ul>
          </li>
          <li><a href="gellery.php">Images</a></li>
          <li><a href="viewvideo1.php">Videos</a></li>
